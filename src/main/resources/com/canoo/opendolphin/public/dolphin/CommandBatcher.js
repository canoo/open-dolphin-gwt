    ...
    (function (dolphin) {
        ...
        var BlindCommandBatcher = (function () {
            ...
            BlindCommandBatcher.prototype.processNext = function (queue, batch) {
                ...
                if (!candidate.handler && !(candidate.command['className'] == "org.opendolphin.core.comm.NamedCommand") && !(candidate.command['className'] == "org.opendolphin.core.dolphin.EmptyNotification")) {
